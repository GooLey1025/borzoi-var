...
def main():
    ...
    sed_options.add_option(
        "-g",
        dest="genes_gtf",
        default="%s/genes/gencode41/gencode41_basic_nort.gtf"
    ...
    if fit_classifiers:
        ...
        cmd_base += " borzoi_bench_classify.py -i 100 -p 2 -r 44 -s --stat nDi"
            ...
            if not line.startswith("#"):
                ...
                if snp in snp_si:
                    ...
                    for ss in sed_stats:
                        ...
                        sed_scores_si = np.array(
                            [merge_scores[ss][i] for i in snp_si[snp]]
                        )
